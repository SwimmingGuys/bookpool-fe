...
export default function HeroBanner() {
  ...
  return (
    <section className="relative overflow-hidden bg-stone-800 px-6 py-16 md:py-24">
      <div
      ...
      >
        <h1 className="text-3xl md:text-5xl font-bold text-stone-50 leading-tight tracking-tight">
          깊게 읽고, 진심을 나누는
          <br />
          서평단 플랫폼
        </h1>
